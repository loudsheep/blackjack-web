...
export function DealerArea({ dealerHand, phase, deckCount = 6, deckRemaining = 312 }: DealerAreaProps) {
  ...
  return (
    <div className="flex flex-col items-center gap-4 relative">
       ...
       <div className="flex items-center justify-center gap-8 relative z-10 w-full">
           ...
           {/* Deck Shoe (Left of Dealer) - Hidden on mobile */}
           {/* <div className="hidden md:block absolute -left-32 top-0">
               <DeckShoe deckCount={deckCount} cardsRemaining={deckRemaining} />
           </div> */}
